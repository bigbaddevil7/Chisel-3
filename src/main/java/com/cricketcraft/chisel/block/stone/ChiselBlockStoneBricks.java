...
public class ChiselBlockStoneBricks extends BlockCarvable implements IChiselBlock {
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, ChiselProperties.STONE_BRICKS_VARIANTS);
    }
}
