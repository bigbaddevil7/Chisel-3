...
public class ChiselBlockNetherBrick extends BlockCarvable implements IChiselBlock {
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, ChiselProperties.NETHERBRICK_VARIANTS);
    }
}
