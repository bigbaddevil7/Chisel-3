...
public class ChiselBlockStainedGlassPaneGreen extends BlockCarvablePane implements IChiselBlock {
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, ChiselProperties.STAINED_GLASS_PANE_GREEN_VARIANTS, NORTH, SOUTH, EAST, WEST);
    }
}
